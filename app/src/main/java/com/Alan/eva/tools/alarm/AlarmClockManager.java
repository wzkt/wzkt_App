...
public class AlarmClockManager {
    ...
    public static void setAlarm(Context context, Alarm alarm) {
        ...
        if (alarm.enabled == 1) {
            Toast.makeText(context, formatTip(timeMillis), Toast.LENGTH_SHORT).show();
        }
        System.out.println(formatTip(timeMillis));
        // 设置闹钟
    ...
    public static void setNextAlarm(Context context) {
        ...
        if (alarm != null) {
            ...
            Log.e(TAG, "setNextAlarm: "+alarm.hour+alarm.minutes);
    ...
    private static String formatTip(long timeMillis) {
