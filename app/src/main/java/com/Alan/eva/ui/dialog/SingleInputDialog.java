 ...
 * 单输入对话框
 */
public class SingleInputDialog extends AbsDialogCreator {
    ...
    public int getRootViewId() {
        return R.layout.dialog_single_input_operator;
    }

    @Override
    public void findView(View rootView) {
        AppCompatTextView tv_input_dialog_title = (AppCompatTextView) rootView.findViewById(R.id.tv_input_dialog_title);
        edt_input_dialog_content = (AppCompatEditText) rootView.findViewById(R.id.edt_input_dialog_content);
        tv_input_dialog_error_tips = (AppCompatTextView) rootView.findViewById(R.id.tv_input_dialog_error_tips);
        AppCompatTextView tv_input_dialog_cancel = (AppCompatTextView) rootView.findViewById(R.id.tv_input_dialog_cancel);
        AppCompatTextView tv_input_dialog_ok = (AppCompatTextView) rootView.findViewById(R.id.tv_input_dialog_ok);
        tv_input_dialog_title.setText(title);
        edt_input_dialog_content.setInputType(InputType.TYPE_CLASS_NUMBER);
